...
class Data extends AbstractData
{
    ...
    public function approvalCustomerById($customerId, $typeAction = TypeAction::OTHER)
    {
        ...
        $actionResult = $this->approvalAction($customer, AttributeOptions::APPROVED);
        // send email
    ...
    {
        $customer = $this->customerRegistry->retrieve($customerId);
        $actionResult = $this->approvalAction($customer, AttributeOptions::NOTAPPROVE);
        // send email
    ...
    public function approvalAction($customer, $typeApproval)
    {
        ...
        $logger->info("Approval Action response value");
        $logger->info($creationStatus);
    ...
    public function erpCustomerCreation($customerId)
    {
        ...
        try {
            ...
            if ($status) {
                ...
                $logger->info("success response value");
