<?php
	 ...
	 */
	namespace DCKAP\OrderApproval\Block\Order;
	...
	class Totals extends \Magento\Framework\View\Element\Template
	{
		...
		protected function _initTotals()
		{
			...
			if (!$source->getIsVirtual() && ((double)$source->getShippingAmount() || $source->getShippingDescription())) {
				$this->_totals['shipping'] = $this->dataObject->setData([
                    'code' => 'shipping',
			...
			if ((double)$this->getSource()->getDiscountAmount() != 0) {
				...
				$this->_totals['discount'] = $this->dataObject->setData(
						[
								'code' => 'discount',
			...
			$this->_totals['grand_total'] = $this->dataObject->setData(
					[
							'code' => 'grand_total',
							'field' => 'grand_total',
							'strong' => true,
			...
			if ($this->getOrder()->isCurrencyDifferent()) {
				$this->_totals['base_grandtotal'] = $this->dataObject->setData(
						[
