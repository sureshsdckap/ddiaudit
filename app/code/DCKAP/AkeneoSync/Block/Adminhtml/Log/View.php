...
namespace DCKAP\AkeneoSync\Block\Adminhtml\Log;
...
use DCKAP\AkeneoSync\Model\Log as LogModel;

/**
 * Class View
 *
 * @category  Class
 * @package   DCKAP\AkeneoSync\Block\Adminhtml\Log
...
//        return "here";
    ...
    {
        return $this->urlModel->getUrl('dckap_akeneosync/log');
    }
