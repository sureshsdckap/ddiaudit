 ...
 */
namespace AuthorizeNet\ECheck\Test\Unit\Model\Ui\Adminhtml;

use AuthorizeNet\ECheck\Model\Ui\Adminhtml\TokenUiComponentProvider;
...
class TokenUiComponentProviderTest extends TestCase
{
    ...
    public function testGetComponentForToken()
    {
        ...
        $this->componentFactoryMock->expects($this->once())
            ...
            ->with([
                'config' => [
                    'code' => \AuthorizeNet\Echeck\Gateway\Config\Config::VAULT_CODE,
                    ...
                    'template' => 'AuthorizeNet_ECheck::payment/form/vault/renderer.phtml'
                ],
